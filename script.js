...
const fetchChatTags = async () => {
  try {
    const response = await fetch(
      "http://192.168.0.138:8000/get_chattags_keywords/",
      {
        method: "GET",
        headers: {
...
const fetchChatQuestions = async () => {
  try {
    const response = await fetch(
      "http://192.168.0.138:8000/get_chattags_questions/",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
const filterQuestionsByTag = (tagId) => {
  const filteredQuestions = chattagsQuestions.filter(
    (q) => q.chattags_id == tagId
  );
...
const fetchKeywords = async () => {
  try {
    const response = await fetch("http://192.168.0.138:8000/get_keywords/", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        xapi: "1234",
...
const fetchQuestions = async () => {
  try {
    const response = await fetch("http://192.168.0.138:8000/get_questions/", {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        xapi: "1234",
...
const generateResponse = async (chatElement) => {
  ...
  const apiUrl =
    "http://192.168.0.138:8000/get_response/?msg=" +
